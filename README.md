...
**[Download on Gumroad](https://unturneded.gumroad.com/l/PerformanceHUD)** — Get the ready-built app for a one-time $3.99 to support me and the development time that has gone into it. It offers the same features as the version you build yourself and is only a way to support my work. No subscription or feature unlocks.
